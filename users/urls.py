...
from users.views import UserCreateAPIView, UserProfileView, logout_view, CustomTemplateView
...
urlpatterns = [
    ...
    # HTML pages
    path("", CustomTemplateView.as_view(template_name="users/index.html"), name="index"),
